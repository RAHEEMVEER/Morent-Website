...
export default function page() {
  return (
    <section className="flex min-h-[100vh]">
      <CarTypeAndCapacity />
      <div className="flex flex-col bg-[#F6F7F9] lg:px-5">
       <div className="pt-5 grid grid-cols-2 gap-4 min-h-[50vh]">
        <div className="h-max">
          <RentalCar2 visibility="flex"/>
          <div className="mt-2 gap-3 grid grid-cols-3 justify-items-center">
        ...
        <div className="bg-white px-4 py-5 rounded-xl h-max">
          ...
          <div className="mt-8 grid grid-cols-2 gap-x-10 gap-y-2">
       ...
       <div className="mt-10 bg-white flex flex-col gap-4 p-3 rounded-lg">
