...
export default function CardOptions() {
  ...
  return (
    <div>
      {options.map((opt) => (
        <div className="bg-[#F6F7F9] px-3 py-3 mt-3 rounded-md">
          <div className="flex justify-between items-center">
            <label className="flex gap-2" htmlFor={opt.option}>
              <input type="radio" id={opt.option} name="card" onClick={() => handleOptionClick(opt.option)}/>
