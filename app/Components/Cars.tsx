...
export default function Cars(props:any) {
  ...
  return (
    <div className='py-4 px-4 bg-white rounded-xl'>
      ...
      <div className='flex justify-between items-center mt-4'><h1 className='text-lg font-semibold'>{props.price}<span className='text-[#6B7280] text-base'>/day</span></h1><Button stylee="bg-[#3563E9] py-2 px-2" content="Rent Now" contentStyle="text-white text-sm"/></div>
    </div>
  )
}
