...
import TypeCapacityLabel from "../Components/TypeCapacityLabel";
...
export default function page() {
  return (
    <section className="flex gap-5 bg-[#F6F7F9] py-5 px-4 lg:px-10 min-h-[100vh]">
      <div className="flex flex-col gap-5 w-[60%]">
        ...
        <div className="bg-white px-5 py-6 rounded-md">
          <div className="flex justify-between items-center mb-6">
            <div><h1 className="text-lg font-semibold">Confirmation</h1><p className="text-sm text-[#90A3BF]">We are getting to the end. Just few clicks and your rental is ready!</p></div>
            <p className="text-sm text-[#90A3BF]">Step 4of4</p>
          </div>
          <div className="flex flex-col gap-4 mb-6">
            <div className="bg-[#F6F7F9] px-3 py-2 rounded-md"><TypeCapacityLabel carTypeOrSpace="I agree with sending an Marketing and newsletter emails. No spam, promissed!"/></div>
            <div className="bg-[#F6F7F9] px-3 py-2 rounded-md"><TypeCapacityLabel carTypeOrSpace="I agree with our terms and conditions and privacy policy."/></div>
          </div>
          ...
          <div className="mt-6">
           ...
           <h1 className="text-base font-semibold mt-4">All your data are safe</h1>
           <p className="text-[#90A3BF]">We are using the most advanced security to provide you the best experience ever.</p>
          </div>
        </div>
      </div>

      <div className="w-[40%] bg-white py-6 px-5 h-max rounded-md">
        ...
        <div className="flex gap-5 mt-7">
          <div className="bg-[url(/images/bg2.png)] bg-center bg-cover rounded-md flex justify-center items-center p-4"><Image src={gtr} alt="car interior" className="w-[150px]"/></div>
       ...
       <div className="flex mt-5">
         <input type="text" className="bg-[#F6F7F9] w-full outline-none text-[#90A3BF] py-2 px-3" placeholder="Apply promo code"/>
         <Button stylee="bg-[#F6F7F9] py-2 px-2 w-[120px]" contentStyle="text-black text-sm" content="Apply Now"/>
       </div>
